      ...
      <img
        ...
        :class="{
          'item-selected':
            ...
            parseInt(item.viewID) == $store.state.character.headgear[1],
        }"
        :viewID="item.viewID"
        :id="item.id"
  ...
  data() {
    return {
      items: [
        ...
        { id: 19918, name: "Máscara de Lude", viewID: 802 },
        ...
        { id: 31313, name: "Asas do Anjo Renegado", viewID: 1662 },
        ...
        { id: 31480, name: "Gioia Dorminhoco", viewID: 1730 },
        { id: 31482, name: "Cachecol de Lunático", viewID: 1732 },
        { id: 31483, name: "Adereço de Gatinho", viewID: 1733 },
